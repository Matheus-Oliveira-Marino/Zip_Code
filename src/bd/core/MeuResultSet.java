...
/**
 * A classe {@code MeuResultSet} é uma implementação personalizada da interface {@code ResultSet}, 
 * que atua como um 'wrapper' em torno de um 'ResultSet' padrão. Ela 
 * fornece funcionalidades adicionais ou personalizadas sobre o 'ResultSet' padrão.
 */
